document.getElementById("submit").addEventListener("click", function() {
  ...
  if(your_sign == "Aries" || your_sign == "aries"){
  ...
  else if(your_sign == "Taurus" || your_sign == "taurus"){
  ...
  else if(your_sign == "Gemini" || your_sign == "gemini"){
  ...
  else if(your_sign == "Cancer" || your_sign == "cancer"){
  ...
  else if(your_sign == "Leo" || your_sign == "leo"){
  ...
  else if(your_sign == "Virgo" || your_sign == "virgo"){
  ...
  else if(your_sign == "Libra" || your_sign == "libra"){
  ...
  else if(your_sign == "Scorpio" || your_sign == "scorpio"){
  ...
  else if(your_sign == "Sagittarius" || your_sign == "sagittarius"){
  ...
  else if(your_sign == "Capricorn" || your_sign == "capricorn"){
  ...
  else if(your_sign == "Aquarius" || your_sign == "aquarius"){
  ...
  else if(your_sign == "Pisces" || your_sign == "pisces"){
